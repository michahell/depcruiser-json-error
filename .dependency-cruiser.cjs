...
module.exports = {
  forbidden: [
    ...
    {
      name: 'cross-team-modules',
      comment: 'One feature should not depend on another feature (in a separate folder)',
      severity: 'error',
      from: { path: '(^src/app/modules/)([^/]+)/' },
      to: { path: '^$1', pathNot: ['$1$2', '(^src/app/modules/dwp)'] },
    },
  ],
  options: {
    ...
    */
    ...
    enhancedResolveOptions: {
      ...
      */
      ...
      /* only scan files with the following extensions */
      extensions: ['.ts', '.json'],
    },
    reporterOptions: {
      dot: {
